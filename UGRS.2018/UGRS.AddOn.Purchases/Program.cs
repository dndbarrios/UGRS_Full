    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
               ...
               UIApplication.ShowSuccess(string.Format("AddonCompras 1.2.71 iniciado correctamente"));
                LogService.WriteSuccess(string.Format("AddonCompras 1.2.71 iniciado correctamente"));
                oApp.Run();
