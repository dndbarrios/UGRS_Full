...
namespace UGRS.InvRevaluationSDK.SDK.DAO {
    public class InvRevaluationDAO : BaseDAO {
        ...
        public RevaluationItem[] GetInvRevaluationItems(string docNum, string type) => GetArray<RevaluationItem>(this.GetSQL($"GetRevaluation{type}").Replace("{DocNum}", docNum));
    }
}
